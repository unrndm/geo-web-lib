...
//                     Err(format!("Mismatched types: {:#?} & {:#?}", old, new))
//                 } else {
...
//                         Err(format!("Geometry type not supported: {}", geom_type))
//                     } else {
...
// // pub struct PointDiffer {}

// // impl IDiffer for PointDiffer {
// //     fn create_diff(&self, change: Change) -> Self {
// //         PointDiff {c}
// //     }
// // }

// pub trait IDiff: Debug {
